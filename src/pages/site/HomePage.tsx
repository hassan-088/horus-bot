...
export default function HomePage() {
  ...
  return (
    <>
      ...
      >
        <div className="mx-auto mt-10 max-w-4xl rounded-3xl border border-primary/25 bg-card/65 p-3 shadow-soft backdrop-blur-xl md:p-4">
          <div className="grid gap-3 md:grid-cols-3">
            {[
              ...
              <div key={item.en} className="rounded-2xl bg-background/45 p-4 text-start ring-1 ring-primary/15 transition-all duration-300 hover:bg-background/60 hover:shadow-soft">
      ...
      {/* EXPERIENCE PREVIEW */}
      <section className="mx-auto max-w-7xl px-4 md:px-8 py-14 md:py-24">
        <div className="relative overflow-hidden rounded-[2rem] ring-1 ring-primary/20 shadow-[0_28px_90px_-28px_hsl(var(--primary)/0.45)]">
          ...
          <div className="absolute inset-x-0 bottom-0 grid gap-8 p-6 md:grid-cols-[1.1fr_0.9fr] md:p-10">
            <div>
            ...
            <div className="self-end grid gap-3">
              {[
                ...
                <div key={item.en} className="flex items-center gap-3 rounded-2xl border border-primary/20 bg-card/70 px-4 py-3 text-sm shadow-soft backdrop-blur">
      ...
      <section className="bg-sidebar/15">
        <div className="mx-auto grid max-w-7xl gap-10 px-4 md:px-8 py-16 md:grid-cols-[0.82fr_1.18fr] md:py-24">
          <div>
          ...
          <div className="grid gap-4 sm:grid-cols-2">
            {[
              ...
              <div key={item.titleEn} className="rounded-2xl border border-primary/15 bg-card/65 p-5 shadow-soft backdrop-blur transition-colors hover:border-primary/30">
                <item.icon className="mb-3 h-5 w-5 text-primary" />
      ...
      {/* MUSEUM VALUE */}
      <section className="bg-sidebar/15">
        <div className="mx-auto grid max-w-7xl gap-10 px-4 md:px-8 py-16 md:grid-cols-[0.95fr_1.05fr] md:py-24">
          <div>
          ...
          <div className="grid gap-4 sm:grid-cols-2">
            {[
              ...
              <div key={item.en} className="rounded-2xl border border-primary/15 bg-card/60 p-5 shadow-soft">
      ...
      {/* FINAL CTA */}
      <section className="mx-auto max-w-5xl px-4 md:px-8 py-16 md:py-24">
        <div className="rounded-[2rem] border border-primary/25 bg-gradient-to-br from-card/90 via-card/75 to-primary/10 p-8 text-center shadow-[0_22px_70px_-35px_hsl(var(--primary)/0.55)] backdrop-blur md:p-12">
          <h2 className="font-serif text-3xl md:text-5xl text-foreground mb-6">
